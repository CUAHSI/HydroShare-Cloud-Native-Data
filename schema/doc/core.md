...
Core metadata is a set of common fields that all scientific 
data share and consists largely of high-level dataset attributes
and properties. This document outlines the **required** and **optional**
properties selected from Schema.Org vocabulary to guide its use for scientific content. These properties are encoded as `1` or `1+` 
...
``` json
{
  "name": "My Dataset Example",
  "description": "This resource contains a Jupyter notebook that demonstrates a cool scientific content.",
  "url": "https://www.hydroshare.org/resource/abcderfghij123456789/"
}
```
...
``` json
{
  "identifier": "abcderfghij123456789/"
}
```
...
``` json
{
  "identifier": "https://www.hydroshare.org/resource/abcderfghij123456789/"
}
```
...
[MDN reference](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types)). `sha256` is a 256-bit hash value generated by a cryptographic function, representing the content of an item as a string. 
...
``` json
{
 "associatedMedia": {
    ...
    "sha256": "lab0c44298fc1c149afbf4c8976fb92427ae41e464c4934ca495991b7852b855",
    "contentSize": "79.2 MB",
  ...
  "associatedMedia": [
   {
    ...
    "contentUrl": "https://www.hydroshare.org/resource/51d1539bf6e94b15ac33f7631228118c/data/contents/USGS_Harvey_gages_TxLaMsAr.csv",
    "encodingFormat": "text/csv",
    "sha256": "ae41e464c4934ca495991b7852b855lab0c44298fc1c149afbf4c8976fb92427",
    "contentSize": "0.17 MB",
    "name": "USGS gage locations within the Harvey-affected areas in Texas"
   },
   {
     ...
     "sha256": "5lab0c44298fc1c149afae41e464c4934ca495991b7852b85bf4c8976fb92427",
     "contentSize": "8.9 MB",
   ...
   },
   {
     ...
     "sha256": "934ca495991b7852b85bf4c8976fb924275lab0c44298fc1c149afae41e464c4",
     "contentSize": "0.96 MB",
