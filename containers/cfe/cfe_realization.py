...
class GlobalRealization:
    def __init__(
        self, global_params=None, time=None, routing=None, catchment_realizations=None
    ):
...
def make_catchment_configs(
    base_dir: pathlib.Path, catchment_configs: typing.Dict[str, dict]
) -> None:
    """
...
def create_cfe_realization(
    ...
    for key, _ in catchment_configs.items():
        ...
        f = Formulation(
            "bmi_multi", params=form_params, modules=[sloth_module, cfe_module]
        )
