...
def make_catchment_configs(base_dir: pathlib.Path,
                           catchment_configs: typing.Dict[str, dict]) -> None:
    """
...
def create_cfe_realization(base_dir: pathlib.Path,
    ...
    for key, _ in catchment_configs.items():
        ...
        cfe_module = Module('bmi_c', params=module_params)
        ...
        sloth_module = Module('bmi_c++', params=module_params)
        ...
        form_params = {"name": "bmi_multi",
                       ...
                       "fixed_time_step": False,
                       "uses_forcing_file": False}
        f = Formulation('bmi_multi',
                        params=form_params,
                        modules=[sloth_module,
                                 cfe_module])
    ...
    # modify
    # TODO: These need to be input parameters.
    ngen['network_topology_parameters']['supernetwork_parameters']['geo_file_path'] = f'/ngen/data/domain/{geopackage}'
    ...
    ngen['output_parameters']['lite_restart']['lite_restart_output_directory'] = '/ngen/data/results/restart' 
    ngen['output_parameters']['lakeout_output'] = '/ngen/data/results/lakeout' 
    ngen['output_parameters']['stream_output']['stream_output_directory'] = '/ngen/data/results/streamout' 
    # save
